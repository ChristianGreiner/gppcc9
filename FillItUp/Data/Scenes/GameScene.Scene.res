<root dataType="Struct" type="Duality.Resources.Scene" id="129723834">
  ...
  <serializeObj dataType="Array" type="Duality.GameObject[]" id="427169525">
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="3428221431">
        <_items dataType="Array" type="Duality.Component[]" id="4283982478" length="4">
          <item dataType="Struct" type="FillItUp.GameManager" id="378336785">
            <active dataType="Bool">true</active>
            <activeCup dataType="Struct" type="FillItUp.Cup" id="1108192507">
              <active dataType="Bool">true</active>
              <gameobj />
              <waterRenderer />
            </activeCup>
    ...
    <item dataType="Struct" type="Duality.GameObject" id="3693600976">
      <active dataType="Bool">true</active>
      <children dataType="Struct" type="System.Collections.Generic.List`1[[Duality.GameObject]]" id="1170830198">
        <_items dataType="Array" type="Duality.GameObject[]" id="841896928" length="4">
          <item dataType="Struct" type="Duality.GameObject" id="796989925">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1015834769">
              <_items dataType="Array" type="Duality.Component[]" id="3040028142" length="4">
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2829599392" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="1992282939">
                  <item dataType="ObjectRef">1036162158</item>
                  <item dataType="Type" id="1928159958" value="Duality.Components.Renderers.SpriteRenderer" />
                </keys>
                <values dataType="Array" type="System.Object[]" id="735625768">
            ...
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="861434033">QFOLrwpe80qwzt6VV1fCVg==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
          ...
          <item dataType="Struct" type="Duality.GameObject" id="613451190">
            <active dataType="Bool">true</active>
            <children />
            <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="1508229846">
              <_items dataType="Array" type="Duality.Component[]" id="3929537824" length="4">
                ...
                <item dataType="Struct" type="Duality.Components.Renderers.SpriteRenderer" id="2255617758">
                  <active dataType="Bool">true</active>
                  <colorTint dataType="Struct" type="Duality.Drawing.ColorRgba">
            ...
            <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="2300162010" surrogate="true">
              <header />
              <body>
                <keys dataType="Array" type="System.Object[]" id="1821127076">
                  <item dataType="ObjectRef">1036162158</item>
                  <item dataType="ObjectRef">1928159958</item>
                </keys>
                <values dataType="Array" type="System.Object[]" id="4214482710">
            ...
            <identifier dataType="Struct" type="System.Guid" surrogate="true">
              <header>
                <data dataType="Array" type="System.Byte[]" id="2580274336">zMtiOvIpVU6L0TcGE/qFLw==</data>
              </header>
              <body />
            </identifier>
            <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
      ...
      <compList dataType="Struct" type="System.Collections.Generic.List`1[[Duality.Component]]" id="728704282">
        <_items dataType="Array" type="Duality.Component[]" id="1296785988" length="4">
          ...
          <item dataType="Struct" type="FillItUp.Cup" id="3412224861">
            <active dataType="Bool">true</active>
            <gameobj dataType="ObjectRef">3693600976</gameobj>
            <waterRenderer dataType="ObjectRef">2439156493</waterRenderer>
          </item>
        </_items>
        <_size dataType="Int">3</_size>
        <_version dataType="Int">9</_version>
      </compList>
      <compMap dataType="Struct" type="System.Collections.Generic.Dictionary`2[[System.Type],[Duality.Component]]" id="3482706582" surrogate="true">
        <header />
        <body>
          <keys dataType="Array" type="System.Object[]" id="1392708544">
            <item dataType="ObjectRef">1036162158</item>
            <item dataType="ObjectRef">1928159958</item>
            <item dataType="Type" id="1252311836" value="FillItUp.Cup" />
          </keys>
          <values dataType="Array" type="System.Object[]" id="2703162446">
            <item dataType="ObjectRef">1758948612</item>
      ...
      <identifier dataType="Struct" type="System.Guid" surrogate="true">
        <header>
          <data dataType="Array" type="System.Byte[]" id="166952796">maxSRXXjfUyrlXrvfeJINA==</data>
        </header>
        <body />
      </identifier>
      <initState dataType="Enum" type="Duality.InitState" name="Initialized" value="1" />
